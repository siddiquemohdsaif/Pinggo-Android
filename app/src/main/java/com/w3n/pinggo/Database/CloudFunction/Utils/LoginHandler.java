...
public class LoginHandler {
  ...
  public static void checkUserExists(
      AppRestAPI appApi, String phoneNumber, AppFunctionManager.Callback callback) {
    ...
    Call<JsonObject> login =
        appApi.checkUserExists(
            RequestBody.create(body, MediaType.parse("application/json; charset=utf-8")));
    login.enqueue(
        new Callback<JsonObject>() {
          @Override
          public void onResponse(
              @NonNull Call<JsonObject> call, @NonNull Response<JsonObject> response) {
  ...
  private static void handleCheckUserExistsResponse(
      Response<JsonObject> response, AppFunctionManager.Callback callback) {
  ...
  public static void login(
    ...
    Call<JsonObject> login =
        appApi.login(RequestBody.create(body, MediaType.parse("application/json; charset=utf-8")));
    login.enqueue(
        new Callback<JsonObject>() {
          @Override
          public void onResponse(
  ...
  public static void signUp(
    ...
    Call<JsonObject> signup =
        appApi.signup(RequestBody.create(body, MediaType.parse("application/json; charset=utf-8")));
    signup.enqueue(
        new Callback<JsonObject>() {
          @Override
          public void onResponse(
