...
public class ProfileUpdateHandler {
  ...
  public static void updateName(
      AppRestAPI appApi, String name, AppFunctionManager.Callback callback) {
    enqueueUpdate(appApi.updateName(createBody("name", name)), "name", name, callback);
  }

  public static void updateEmail(
      AppRestAPI appApi, String email, AppFunctionManager.Callback callback) {
  ...
  private static void enqueueUpdate(
      Call<JsonObject> call, String field, String value, AppFunctionManager.Callback callback) {
    call.enqueue(
  ...
  private static void handleUpdateResponse(
