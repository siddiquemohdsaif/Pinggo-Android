...
public class UserData {
    ...
    public UserData(String id, String phoneNumber, ProfileData profileData, String encryptedCredential, long createdAt, long lastSeen) {
        this._id = id;
    ...
    public static class ProfileData {
        ...
        public ProfileData(String name, String dob, String phoneNumber, String email, String P_ID) {
            this.name = name;
            this.dob = dob;
            this.phoneNumber = phoneNumber;
            this.email = email;
