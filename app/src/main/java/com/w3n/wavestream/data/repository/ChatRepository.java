package com.w3n.wavestream.data.repository;
...
import com.w3n.wavestream.data.local.MessageDao;
import com.w3n.wavestream.data.local.MessageEntity;
import com.w3n.wavestream.data.local.MessageStatus;
import com.w3n.wavestream.data.local.ChatDao;
import com.w3n.wavestream.data.local.ChatEntity;
import com.w3n.wavestream.data.local.PresenceDao;
import com.w3n.wavestream.data.local.PresenceEntity;
import com.w3n.wavestream.data.local.WaveStreamDatabase;
import com.w3n.wavestream.data.remote.AuthenticatedApiFactory;
import com.w3n.wavestream.data.remote.ChatApiService;
import com.w3n.wavestream.data.remote.ChatWebSocketClient;
import com.w3n.wavestream.data.remote.JsonParserUtil;
...
public class ChatRepository implements ChatWebSocketClient.Listener {
    ...
    private ChatRepository(Context context) {
        ...
        WaveStreamDatabase database = WaveStreamDatabase.getInstance(appContext);
