...
public class CallDetailActivity extends AppCompatActivity {
    public static final String EXTRA_CONTACT_NAME = "com.w3n.wavestream.EXTRA_CONTACT_NAME";
    public static final String EXTRA_CALLED_TIME = "com.w3n.wavestream.EXTRA_CALLED_TIME";
    public static final String EXTRA_FULL_CALLED_DATE_TIME = "com.w3n.wavestream.EXTRA_FULL_CALLED_DATE_TIME";
    public static final String EXTRA_DURATION = "com.w3n.wavestream.EXTRA_DURATION";
    public static final String EXTRA_IS_VIDEO_CALL = "com.w3n.wavestream.EXTRA_IS_VIDEO_CALL";
